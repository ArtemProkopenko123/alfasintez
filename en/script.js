$( document ).ready(function() {
    ...
    $(window).on('scroll', function () {
        ...
        if($(window).width() >= 1025) {
            /*---------------------------- PARALAX -----------------------------------*/
            var lastScrollTop = 0, st = $(this).scrollTop();
            if (st > lastScrollTop) {
        ...
        if ($(this).scrollTop() > $section_2 / 3 ) {  $('.section-page-2 .line-style').addClass("setWidth")};
        if ($(this).scrollTop() > $section_8 /1.18 ) {  $('.section-page-8 .line-style').addClass("setWidth")};
        ...
        } else {$('#van_map_img').removeClass("van_animation")};
    ...
    if ($(window).scrollTop() > $section_2 / 3 ) {  $('.section-page-2 .line-style').addClass("setWidth")};
    if ($(window).scrollTop() > $section_8 / 1.18  ) {  $('.section-page-8 .line-style').addClass("setWidth")};
    ...
    if(window_size > 700) {$('.main-text-1st-page').css("top", "" + (window_size / 5 ) + "px")
    } else {
    ...
    $(window).on("resize", function() {
        ...
        $('.BG-1st-page, .container-1st-page').height(window_size - 3 + "px")
        if(window_size > 700) {$('.main-text-1st-page').css("top", "" + (window_size / 7 ) + "px")
        } else {$('.main-text-1st-page').css("top", "" + (window_size / 10 ) + "px")}
